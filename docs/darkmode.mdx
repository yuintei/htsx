...
:root {
  ...
  --code-line-highlight-bg: oklch(0.94 0.006 264 / 0.9);
  --code-line-highlight-border: oklch(0.72 0.008 264);
}
...
.dark {
  ...
  --code-line-highlight-bg: oklch(0.31 0.013 264 / 0.95);
  --code-line-highlight-border: oklch(0.68 0.015 264);
}
```
